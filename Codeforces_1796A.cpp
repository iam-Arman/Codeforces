...
void solve()
{
   int n;
    cin>>n;
    string k="";

    string s;
    cin>>s;
    bool ok=false;
    if(k.find(s)!=string::npos) ok=true;
    if(ok) cout<<"YES"<<el;
    else cout<<"NO"<<el;
}
