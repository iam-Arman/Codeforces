...
{  
    ...
    if(v[0][0]==v[0][1] and v[0][1]==v[0][2] and v[0][0]!='.')
    {
        cout<<v[0][0]<<el;
        return;
    }
    if(v[1][0]==v[1][1] and v[1][1]==v[1][2] and v[1][0]!='.')
    {
        cout<<v[1][0]<<el;
        return;
    }
    if(v[2][0]==v[2][1] and v[2][1]==v[2][2] and v[2][0]!='.')
    {
        cout<<v[2][0]<<el;
        return;
    }

    if(v[0][0]==v[1][0] and v[1][0]==v[2][0] and v[0][0]!='.')
    {
        cout<<v[0][0]<<el;
        return;
    }
    if(v[0][1]==v[1][1] and v[1][1]==v[2][1] and v[0][1]!='.')
    {
        cout<<v[0][1]<<el;
        return;
    }
    if(v[0][2]==v[1][2] and v[1][2]==v[2][2] and v[0][2]!='.')
    {
        cout<<v[0][2]<<el;
        return;
    }
    ...
    if(v[2][0]==v[1][1] and v[1][1]==v[0][2] and v[2][0]!='.')
    {
        cout<<v[2][0]<<el;
        return;
    }
